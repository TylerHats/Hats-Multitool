# Windows Update GUI Module - Tyler Hatfield - v1.8
...
# Popup to inform user GUI is loading
#Hide-ConsoleWindow # Hidden for now until proven NuGet will not prompt
$WULGUI = New-Object System.Windows.Forms.Form
$WULGUI.Text = "Hat's Multitool"
$WULGUI.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#2f3136")
$WULGUI.Size = New-Object System.Drawing.Size(400, 110)
$WULGUI.StartPosition = 'CenterScreen'
$WULGUI.Icon = $HMTIcon
$WULGUI.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::FixedDialog
$WULGUI.MaximizeBox = $false
$WULGUI.Font = $font
$WULGUI.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::Font

# Add descriptive label
$y = 20
$WULlabel = New-Object System.Windows.Forms.Label
$WULlabel.Text = "WinUpdates GUI is loading..."
$WULlabel.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#d9d9d9")
$WULlabel.Size = New-Object System.Drawing.Size(400, 30)
$WULlabel.Location = New-Object System.Drawing.Point(0, $y)
$WULlabel.AutoSize = $false
$WULlabel.TextAlign = 'TopCenter'
$WULGUI.Controls.Add($WULlabel)

# Display GUI
$WULGUI.Show() | Out-Null
